...
$table_text = get_option( 'yith_woocompare_table_text', esc_html__( 'Compare products', 'hub' ) );
...
<h1>
    ...
    <?php if ( ! $is_iframe ) : ?><a class="close" href="#"><?php esc_html_e( 'Close window [X]', 'hub' ) ?></a><?php endif; ?>
</h1>
...
<div id="yith-woocompare" class="woocommerce">
    ...
    <?php if ( empty( $products ) ) : ?>
        ...
        <tr class="no-products">
            <td><?php esc_html_e( 'No products added in the compare table.', 'hub' ) ?></td>
        </tr>
        ...
        <tr class="remove">
            ...
            foreach( $products as $product_id => $product ) :
                ...
                <td class="<?php echo sanitize_html_class( $product_class ); ?>">
                    <a href="<?php echo add_query_arg( 'redirect', 'view', $this->remove_product_url( $product_id ) ) ?>" data-product_id="<?php echo esc_attr( $product_id ); ?>"><?php esc_html_e( 'Remove', 'hub' ) ?> <span class="remove">x</span></a>
                </td>
                <?php
                ++$index;
            endforeach;
