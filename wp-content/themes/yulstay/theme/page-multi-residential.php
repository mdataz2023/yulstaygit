...
<div class="h-screen w-screen mr-12 grid grid-cols-1 md:grid-cols-2 p-14 gap-6">
    ...
    <div class="md:block hidden">
        ...
        <div class="md:block hidden">
            <a href="<?php bloginfo('url'); ?>/home"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/5.png" class="w-32 pb-4" alt=""></a>
          </div>
    ...
    <div class="col-scroll">
        ...
        <div class="text-black">
            ...
            <div class="d-flex flex-row mb-3 text-white mt-4 gap-4 text-uppercase text-black">
                ...
                <div class="text-black" style="font-size: 25px;font-weight: bold;"><a href>Multi-Residential</a></div>
...
$categoryDivName=$category->name;
    ...
    echo '<h2 class="category-name text-black text-5xl md:text-lg md:text-white">' . esc_html($category->name) . '</h2>';
