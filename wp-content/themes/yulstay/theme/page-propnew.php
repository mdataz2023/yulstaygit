            ...
            <div class="">
              <!-- caro -->
                <div id="app" class="transition-all duration-500 ease-linear pb-7">
                  <div class="relative">
                    <div class="slides-container h-[350px] flex snap-x snap-mandatory overflow-hidden overflow-x-auto space-x-2 rounded scroll-smooth before:w-[45vw] before:shrink-0 after:w-[45vw] after:shrink-0 md:before:w-0 md:after:w-0">
                      <div class="slide aspect-[4/3] h-full flex-shrink-0 snap-center overflow-hidden">
                        <img class="w-full h-full object-cover" src="./assest/img/10578486-1-327342585.jpg" alt="mountain_image">
                      </div>
                      <div class="slide aspect-[4/3] h-full flex-shrink-0 snap-center overflow-hidden">
