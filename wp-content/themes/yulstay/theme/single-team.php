     ...
     <div class="col-span-1 md:col-span-7 col-scroll">
          <div>
               ...
               <div>
                    ...
                    <p><?php echo $team_member_position; ?></p>
                    <div class="flex">
                         <div>
                    ...
                    <div class="flex">
                         ...
                         <div>
                              <a href="<?php echo $website_link; ?>"><?php echo $website; ?></a>
                         </div>
                    </div>
                    <div class="flex">
                         <div>
                         ...
                         <div>
                              <a href="<?php echo $home_address_link; ?>"><?php echo $home_address; ?></a>
                         </div>
                    </div>
                    <div class="flex">
                         <div>
                         ...
                         <div>
                              <a href="<?php echo $office_address_link; ?>"><?php echo $office_address; ?></a>
                         </div>
                    </div>
                    <div class="flex">
                         <div>
