...
$home_address_link = get_field('home_address_link');
$home_address = get_field('home_address');

$office_address_link = get_field('office_address_link');
...
<div class="h-screen w-screen mr-12 grid grid-cols-1 md:grid-cols-12 p-14 gap-4">
     ...
     <div class="col-span-1 md:col-span-5">
               <div class="flex gap-3 mb-3">
				<div><a href="<?php bloginfo('url'); ?>/home" class="text-gray-400 hover:text-gray-800 font-bold">Home</a></div>
				...
				<!-- <div><a href="<?php bloginfo('url'); ?>/home" class="text-gray-400 hover:text-gray-800 font-bold">Info</a></div>
                    <div class="flex items-center content-between">
					<div>
						<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-caret-right-fill" viewBox="0 0 16 16">
						<path d="m12.14 8.753-5.482 4.796c-.646.566-1.658.106-1.658-.753V3.204a1 1 0 0 1 1.659-.753l5.48 4.796a1 1 0 0 1 0 1.506z"/>
     ...
     <div class="col-span-1 md:col-span-7 col-scroll scroll-style">
          <div>
               ...
               <?php if( have_rows('paragraph_repeater') ): $s= 1; $a=0; ?>
                    ...
                    <div>
                         <p class="font-poppins font-medium text-base pb-2"><?php echo $paragraph; ?></p>
                    </div>
                    <?php   endwhile; endif; ?>
               </div>
               ...
               <div>
                    ...
                    <div class="flex gap-5 pb-2">
                         ...
                         <div>
                              <a class="font-poppins font-medium text-base" href="<?php echo $mobile_link; ?>"><?php echo $mobile; ?></a>
                         </div>
                    </div>
                    <div class="flex gap-5 pb-2">
                         <div>
                         ...
                         <div>
                              <a class="font-poppins font-medium text-base" href="<?php echo $website_link; ?>"><?php echo $website; ?></a>
                         </div>
                    </div>
                    <div class="flex gap-5 pb-2">
                         <div>
                         ...
                         <div>
                              <a class="font-poppins font-medium text-base" href="<?php echo $home_address_link; ?>"><?php echo $home_address; ?></a>
                         </div>
                    </div>
                    <div class="flex gap-5 pb-3">
                         ...
                         <div>
                              <a class="font-poppins font-medium text-base" href="<?php echo $office_address_link; ?>"><?php echo $office_address; ?></a>
                         </div>
                    </div>
...
<script>
     const accordionItems = document.querySelectorAll('.accordion-flush');

accordionItems.forEach(item => {
  const button = item.querySelector('button');
  const body = item.querySelector('.accordion-flush-body');
