...
<div class="h-screen w-screen mr-12 grid grid-cols-1 md:grid-cols-12 px-14 gap-4">
    ...
    <div class="col-span-1 md:col-span-6 col-scroll" id="idCol6" style="text-align: -webkit-center;">
        <div class="bg-cover h-full mb-4  transitionCS7"
            style="background-image: url('<?php echo $multi_residential_image_one; ?>');">
        </div>
        <div class="bg-cover h-full mb-4  transitionCS7"
            style="background-image: url('<?php echo $multi_residential_image_two; ?>');">
        </div>
        <div class="bg-cover h-full mb-4  transitionCS7"
            style="background-image: url('<?php echo $multi_residential_image_three; ?>');">
        </div>
        <div class="bg-cover h-full mb-4  transitionCS7"
            style="background-image: url('<?php echo $multi_residential_image_four; ?>');">
        </div>
        <div class="bg-cover h-full mb-4 transitionCS7"
            style="background-image: url('<?php echo $multi_residential_image_five; ?>');">
        </div>
        <div class="bg-cover h-full mb-4 transitionCS7"
            style="background-image: url('<?php echo $multi_residential_image_six; ?>');">
        </div>
        <div class="bg-cover h-full mb-4 transitionCS7"
            style="background-image: url('<?php echo $multi_residential_image_seven; ?>');">
        </div>
        <div class="bg-cover h-full mb-4 transitionCS7"
            style="background-image: url('<?php echo $multi_residential_image_eight; ?>');">
        </div>
        <div class="bg-cover h-full mb-4 transitionCS7"
            style="background-image: url('<?php echo $multi_residential_image_nine; ?>');">
        </div>
        <div class="bg-cover h-full mb-4 transitionCS7"
            style="background-image: url('<?php echo $multi_residential_image_ten; ?>');">
        </div>
    </div>
</div>
