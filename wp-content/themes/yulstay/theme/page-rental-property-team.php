  ...
  <div class="max-w-7xl mx-auto pr-12 pt-12 pb-16">
        <div class="grid grid-cols-3 gap-6">
            <div class="col-span-2">
                <h1 class="text-4xl font-poppins mb-4">Rental + Property Team</h1>
            ...
            <div class="m-16">
                <a href="<?php bloginfo('url'); ?>/rental-property-contact/">
        ...
        <?php
    $ids_to_display = array(123, 121, 119, 114); // IDs of the posts you want to display114, 116, 123
