...
<div>
  <button id="button1" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mb-4 w-full">Rental / Management</button>
</div>
<div>
  <button id="button2" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mb-4 w-full">Rental + Management</button>
</div>
</div>
...
button1.addEventListener("click", () => {
  const saleContent = `
  <div>
        <div class="font-bold my-3 text-lg">Rental / Management</div>
        <!-- Form Purchase -->
