...
<div class="grid w-screen h-screen grid-cols-1 gap-8 mr-12 overflow-y-scroll md:grid-cols-2 p-14 md:overflow-y-hidden">
    ...
    <?php
    $ids_to_display = array(123, 121, 119, 114); // IDs of the posts you want to display114, 119, 121, 123
...
<div>
  <button id="button1" class="w-full px-4 py-2 mb-4 font-bold text-white bg-blue-500 hover:bg-blue-700">Rental / Management</button>
</div>
<div>
  <button id="button2" class="w-full px-4 py-2 mb-4 font-bold text-white bg-blue-500 hover:bg-blue-700">Rental + Management</button>
</div>
</div>
