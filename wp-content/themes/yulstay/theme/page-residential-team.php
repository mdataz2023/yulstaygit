...
$addendaFile = file_get_contents("http://mdataz.com/public_html/yulstaygit/listing-files/ADDENDA.txt");
$pattern = '/[\n]/';
...
$bureauxFile = file_get_contents("http://mdataz.com/public_html/yulstaygit/listing-files/BUREAUX.txt");
...
$caracteristiquesFile = file_get_contents("http://mdataz.com/public_html/yulstaygit/listing-files/CARACTERISTIQUES.txt");
