...
$book_a_consultation_page_title = get_field('book_a_consultation_page_title');

$book_a_consultation_page_description = get_field('book_a_consultation_page_description');
    ...
    <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
      ...
      <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8">
        ...
        <div class="mx-auto lg:mx-0 lg:max-w-lg md:pr-12">
          ...
          <h2 class="text-3xl font-bold tracking-tight text-gray-900"><?php echo $book_a_consultation_page_title; ?></h2>

          <p class="mt-6 text-lg leading-8 text-gray-600"><?php echo $book_a_consultation_page_description; ?></p>
